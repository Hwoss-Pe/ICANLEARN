...
//    ForumMapper forumMapper;
    ...
    public void Test() {
//
//        String filePath = "hanlp/data/custom.txt";
//
//        InputStream inputStream = IcanlearnApplicationTests.class.getClassLoader().getResourceAsStream(filePath);
...
//        }
        ...
        String text1 = """
                职业规划是指个人根据自身的兴趣、能力和价值观，对未来职业生涯进行系统的规划和设计。它包括对个人职业目标的确定、职业路径的选择、职业技能的培养和职业发展的管理。
        ...
        String text2 = """
                职业规划是人生规划的重要组成部分，它是个人根据自己的兴趣、能力、价值观和社会需求，对自己的职业生涯进行系统的规划和设计。职业规划有助于个人明确职业目标，选择合适的职业道路，并为实现职业目标做好准备。
        ...
        Set<String> list = hanLPUtils.extractNouns(text5, 10);
